                            ...
                            <Container className="py-md">
                                ...
                                <div className="nav-wrapper mr--200">
                                        ...
                                        >
                                            ...
                                            <NavItem>
                                                <NavLink
                                                    aria-selected={this.state.iconTabs2 === 3}
                                                    className={classnames("mb-sm-3 mb-md-3", {
                                                        active: this.state.iconTabs2 === 3
                                                    })}
                                                    onClick={(e) => this.toggleNavs2(e, "iconTabs2", 3)}
                                                    href="#"
                                                    role="tab"
                                                >
                                                    <i className="ni ni-cloud-upload-96 mr-2" />
                                            ...
                                            <NavItem>
                                                 <NavLink
                                                    aria-selected={this.state.iconTabs2 === 4}
                                                    className={classnames("mb-sm-3 mb-md-3", {
                                                        active: this.state.iconTabs2 === 4
                                                    })}
                                                    onClick={(e) => this.toggleNavs2(e, "iconTabs2", 4)}
                                                    href="#"
                                                    role="tab"
                                                >
                                                    <i className="ni ni-bell-55 mr-2" />
                                                ...
                                                <tbody>
                                                        {this.props.birthdays.map((e)=>{
                                                            ...
                                                            <>
                                                                <tr>
                                                                <td>
                                                                    <b style={{fontSize: '13px'}}>{e.message}  - {e.branch}</b>
                                                                </td>
                                                            </tr>
                                                            </>
                                    ...
                                    <Row className="mb-lg-auto" lg="12">
                                                <Col className = "text-md-right ">
                                                    <CardText className="text-white font-weight-light mt-5" tag = "h6">
                                                      <center> YARARLI LİNKLER</center> 
                                                    </CardText>
                                                </Col>
                                        </Row>
                                    <Card className="text-white" style={{ backgroundColor: 'transparent', border: 'none'}}> 
                                        <CardBody style={{ display:'flex', justifyContent:'center' }}>
                                    ...
                                    <Table borderless>
                                        ...
                                        <tr> 
                                            ...
                                            <Card className="card-lift--hover shadow text-white" style={{ backgroundColor: 'rgba(255, 255, 255, 0.5)', border: 'none' }}> 
                                            <td>

                                            </td>
                                            <td style={{ display: 'flex', justifyContent: 'center' }}>
                                                
                                                <a href="https://tevbt.atlassian.net/servicedesk/customer/portals">
                                                        <img src="/jiiraa.png" width="100" height="100"/>
                                                        </a>
                                                </td>
                                                </Card>
                                                ...
                                                <td style={{ display: 'flex', justifyContent: 'center' }}>           
                                                <a href="http://10.1.1.83">
                                                        <img src="/crrmm.png" width="100" height="100"/>
                                                        </a>
                                                </td>
                                                </Card>
                                            </tr>
