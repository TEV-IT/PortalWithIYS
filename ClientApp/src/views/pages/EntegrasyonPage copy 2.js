...
import { BiPlay,BiPause,BiMicrophone,BiMicrophoneOff } from "react-icons/bi";
                        ...
                        >
                            ...
                            <Label for="microfon">
                                Mikrofon Çalışıyor mu? <Button onClick={()=>{
                                    ...
                                    this.state.isPause?this.stopMicrophone():this.startMicrophone()
                                }} outline> {this.state.isPause==true?<BiMicrophone/>:<BiMicrophoneOff/> }</Button>
                                Ses DÜzeyi: {this.state.audioLevel}
                            </Label>
